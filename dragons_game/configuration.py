...
class LevelSelection:
    ...
    LEVEL_BUTTONS_DEST = {
        1: (
            (int(General.SCREEN_WIDTH / 5.80), int(General.SCREEN_HEIGHT / 1.95)),
    ...
    TOP_TILE_IMAGE_PATH = 'dragons_game/graphics/menu_elements/tile.png'
    TOP_TILES_DEST = [(x, 0) for x in range(0, General.SCREEN_WIDTH, int(General.SCREEN_WIDTH / TOP_TILES_NUMBER))]
    TOP_TILES_GAME_STATES = (GameStates.UNKNOWN, GameStates.UNKNOWN, GameStates.UNKNOWN, GameStates.START_SCREEN)
