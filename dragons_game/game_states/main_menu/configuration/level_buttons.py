...
class Island1EasyLevelButtonConfig(_LevelButtonConfig):
    DESTINATION = (
        int(BackgroundConfig.WIDTH / 5.8), BackgroundConfig.DESTINATION[1] + int(BackgroundConfig.HEIGHT / 1.95))
...
class Island1MediumLevelButtonConfig(_LevelButtonConfig):
    DESTINATION = (
        int(BackgroundConfig.WIDTH / 2.7), BackgroundConfig.DESTINATION[1] + int(BackgroundConfig.HEIGHT / 3.7))
    CLICK_ACTION = {UserEventDictKey.ACTION: UserEventDictValue.CHANGE_STATE,
                    UserEventDictKey.NEXT_STATE: GameState.UNKNOWN}
...
class Island1HardLevelButtonConfig(_LevelButtonConfig):
    DESTINATION = (
        int(BackgroundConfig.WIDTH / 1.63), BackgroundConfig.DESTINATION[1] + int(BackgroundConfig.HEIGHT / 1.8))
    CLICK_ACTION = {UserEventDictKey.ACTION: UserEventDictValue.CHANGE_STATE,
                    UserEventDictKey.NEXT_STATE: GameState.UNKNOWN}
...
class Island1FiendishLevelButtonConfig(_LevelButtonConfig):
    DESTINATION = (
        int(BackgroundConfig.WIDTH / 1.2), BackgroundConfig.DESTINATION[1] + int(BackgroundConfig.HEIGHT / 2.7))
    CLICK_ACTION = {UserEventDictKey.ACTION: UserEventDictValue.CHANGE_STATE,
                    UserEventDictKey.NEXT_STATE: GameState.UNKNOWN}
