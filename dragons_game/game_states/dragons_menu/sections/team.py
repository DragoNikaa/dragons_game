...
team_section = ElementsSection((GameConfig.WINDOW_WIDTH / 7, GameConfig.WINDOW_HEIGHT - title_bar_section.height),
                               'topleft', (0, title_bar_section.rect.bottom),
                               'dragons_game/graphics/backgrounds/dragons_menu/team.png')
