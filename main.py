...
from text import Text, TextBorder
...
title_border = title.add_full_border('black', 10)
...
start_button_text_border = start_button_text.add_full_border('black', 4)

start_screen_elements: 'pygame.sprite.Group[Union[Text, TextBorder, Button]]' = pygame.sprite.Group()
start_screen_elements.add(title_border)
start_screen_elements.add(title)
start_screen_elements.add(start_button)
start_screen_elements.add(start_button_text_border)
